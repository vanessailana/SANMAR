        ...
        <div class="row align-item-center">
            ...
            <div class="col-md-4">
                <div class="card border-light h-100">
                    ...
                    <div class="card-body">
                        <p class="card-text">
                          <a href="{{ url('/accounts')}}" class="btn btn-secondary btn-lg btn-block" role="button"> Add, Delete, or Edit Accounts Receivable <i class="fa fa-user-circle-o" aria-hidden="true"></i></i> </a>
                        </p>
                    </div>
                </div>
            </div>
